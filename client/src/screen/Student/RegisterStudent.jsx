...
import { signUpStudentSchema } from "../../schemas";
        ...
        <>
            ...
            }
            {
                ...
                <div className="register-container">
                    ...
                    <div className="register-banner" style={{ backgroundImage: "url('https://static.vecteezy.com/system/resources/previews/000/376/013/original/vector-horizontal-graffiti-banner.jpg')", backgroundPosition: `center ${backgroundPositionY}` }}>
                        <h2>Student Form</h2>
                    ...
                    <form className="register-form" onSubmit={handleSubmit}>
                        ...
                        <div className="section">
                            ...
                            <div className="inp-block">
                                ...
                                {/* <div className="input-block">
                                    <label htmlFor="gName">Guardians Full Name</label>
                                    <input
                                        type="name"
                                        autoComplete="off"
                                        name="gName"
                                        ...
                                        onBlur={handleBlur}
                                    />
                                    {errors.gName && touched.gName ? <p>{errors.gName}</p> : null}
                                </div>
                                <div className="input-block">
                                    <label htmlFor="lName">Realtionship with Guardian</label>
                                    <input
                                        type="text"
                                        autoComplete="off"
                                        name="relation"
                                        id="relation"
                                        placeholder="Your Relation with your Guardian"
                                        value={values.relation}
                                        onChange={handleChange}
                                        onBlur={handleBlur}
                                    />
                                    {errors.relation && touched.relation ? <p>{errors.relation}</p> : null}
                                </div> */}
                                <div className="input-block">
                            ...
                            <div className="inp-block">
                                <div className="input-block">
                                    ...
                                    <input
                                        ...
                                        onBlur={handleBlur}
                                    />
                                    {errors.school && touched.school ? <p>{errors.school}</p> : null}
                                </div>
                                <div className="input-block">
                                ...
                                <div className="input-block">
                                    <label htmlFor="medium">Medium of Schooling</label>
                                    <input
                                        className="styled-select"
                                        name="medium"
                                        id="medium"
                                        placeholder="Your Medium of Schooling"
                                        value={values.medium}
                                        onChange={handleChange}
                                        onBlur={handleBlur}
                                    />

                                    {errors.medium && touched.medium ? <p>{errors.medium}</p> : null}
                                </div>
